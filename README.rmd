...
**arrange.vars** An simple function for rearranging columns in a table. Adapted 
...
**load_prj** An internal function for running a project from a master file
...
**VarByGr** Function which summarizes numeric/int by group

Additional xlsx functions to be used with the xlsx package. Code adapted from 
online postings.  
