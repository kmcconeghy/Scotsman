...
xlsx.AddValue<-function(wb, sheet, value="Header",StartRow=NULL, StartCol=1)
{
  library("xlsx")

  # Define some cell styles within that workbook
  H_STYLE <- CellStyle(wb) + Font(wb, heightInPoints=12, color="white", isItalic=FALSE, isBold=FALSE, underline=0)
